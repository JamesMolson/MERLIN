...
static linking and all examples are buildt in Release mode. The ROOT example
is not built by default. For this example the ROOT libraries and include files 
