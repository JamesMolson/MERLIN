...
int main(int argc, char* argv[])
{
	...
	string input_dir = "/Thesis/data/ClosedOrbit/";
	
	string output_dir = "/Build/Thesis/outputs/ClosedOrbit/";
...
///////////////////////////////////
    ...
    MADInterface* myMADinterface = new MADInterface( directory+input_dir+"nocrossing.tfs", beam_energy );
...
///////////
  ...
  LatticeFunctionTable* myTwiss = new LatticeFunctionTable(myAccModel, beam_energy);
	...
	while(true)
	{
	cout << "start while(true) to scale bend path length, bscale = "<< bscale1 << endl;
    ...
    twiss_output_file << (full_output_dir+"LatticeFunctions.dat");
