 ...
 * 
 * file Merlin\LinearOptics\OpticsTable.h
 * last modified 08/31/00 10:36:15 AM
 */
...
// AcceleratorModel
#include "AcceleratorModel/AdvancedModel/AcceleratorModel.h"
// BeamData
#include "BasicTransport/BeamData.h"
// StringPattern
...
class OpticsTable 
{
  ...
  public:
    //## Constructors (specified)
      ...
      OpticsTable (const AcceleratorModel::Beamline bl, const BeamData& ibeam, ostream& anOs = MERLIN_OUT);
  ...
  private:
    ...
    // Data Members for Associations
      ...
      //## begin OpticsTable::theBeamline%399BE150026E.role preserve=no  private: AcceleratorModel::Beamline { -> 1VHgAN}
      ...
      //## begin OpticsTable::iBeam%399BE1570174.role preserve=no  private: BeamData { -> 1VHgAN}
      BeamData iBeam;
      ...
      //## begin OpticsTable::defaultFmtSpec%399BE52203A1.role preserve=no  private: OPFormat { -> 1VHgAN}
      ...
      //## begin OpticsTable::theColumns%399BEDA3027D.role preserve=no  private: std::list< ColumnSpec  > { -> 1VHgAN}
      ...
      //## begin OpticsTable::itsOutputSpecs%39AA8AB10339.role preserve=no  private: std::set< OutputSpec  > { -> 1VHgAN}
  ...
  private: //## implementation
    ...
    // Data Members for Associations
      ...
      //## begin OpticsTable::lastTwiss%39AD1DB6037D.role preserve=no  implementation: OpticsTable::Twiss { -> 1VHgAN}
      Twiss lastTwiss;
