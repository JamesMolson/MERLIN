...
// Integrator
#include "AcceleratorModel/Integrator.h"
// Components
...
class RmtrxIntegrator : public Integrator  //## Inherits: <unnamed>%3992CC0A0382
{
  public:
...
class TRmtrxIntegrator : public RmtrxIntegrator  //## Inherits: <unnamed>%3992CBD50169
{
  public:
    ...
    //## Other Operations (specified)
      ...
      virtual IndexType GetComponentIndex () const;
...
//## Operation: GetComponentIndex%3992CDF502CA
template <class T>
inline IndexType TRmtrxIntegrator<T>::GetComponentIndex () const
{
...
double RectMultipoleRmtrxI::TrackStep (double ds)
{
  //## begin RectMultipoleRmtrxI::TrackStep%3992CFC103BC.body preserve=yes
	...
	if(ck1.imag()!=0) {
		double cosa = ck1.real()/k1;
		double sina = ck1.imag()/k1;
