...
set output "0.1m_ST.png"
set multiplot layout 3,1 title "Cu 50 SixTrack Test: 0.1m bin"
#
set tmargin 3
set title "x"
#
...
plot "Ref.dat" u 1:3 title "reference", "HEL_S_hist.txt" u 1:3 title "merged" 
#
set title "dp"
#
unset key
...
#~ set log x
plot "Ref.dat" u 1:4 title "reference", "HEL_S_hist.txt" u 1:4 title "merged" 
#
unset multiplot
#
